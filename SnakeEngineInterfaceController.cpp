...
void SnakeEngineInterfaceController::attach(SnecObserver *observer, std::vector<SnecListenerCatagorization> catagorizations)
{
    std::for_each(catagorizations.begin(), catagorizations.end(),[&](SnecListenerCatagorization catagory)
    {
        switch (catagory)
        {
            case ALL:
